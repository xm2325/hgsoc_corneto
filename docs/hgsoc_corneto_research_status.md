...
Last operational update: 2026-08-12 12:22 BST (15:22 EEST). This file is the project-level source of
...
|---|---:|---|---:|---|
| E-MTAB-7223 | 588250 | Running 20 h 44 min; about 3 h 16 min remain on the 24 h limit | **600005**, pending `afterany:588250`, skip if existing receipt validates | 72 h, 128G, 8 CPU |
| E-MTAB-10801 | 588251 | Failed: genuine 64G OOM | **600004**, running 4 h 42 min with no startup error or receipt yet | 72 h, 196G, 8 CPU |
| E-MTAB-11000 | 588252 | Running 20 h 44 min; about 3 h 16 min remain on the 24 h limit | **600006**, pending `afterany:588252`, skip if existing receipt validates | 72 h, 128G, 8 CPU |
| E-MTAB-14568 | 588253 | Running 20 h 44 min; about 51 h 16 min remain on the 72 h limit | **600007**, pending `afterany:588253`, skip if existing receipt validates | 72 h, 196G, 8 CPU |

At the 15:22 EEST inspection, active-step peak RSS was about 22.6/24.4/27.5
GiB for 588250/588252/588253, 11.8 GiB for 600004, and 4.0 GiB for 600008.
...
smoke succeeds, but neither depends on the cohort baselines. At the 15:22 EEST
checkpoint, smoke job **600008** had run for 4 h 42 min, was continuing the
