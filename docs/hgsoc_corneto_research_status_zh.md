...
最后运行更新：2026-08-12 13:44 BST（16:44 EEST）。本文件与
...
|---|---:|---|---:|---|
| E-MTAB-7223 | 588250 | 运行 22 h 07 min；24 h limit 约剩 1 h 53 min | **600005**，afterany:588250；若已有 receipt 验证有效则跳过 | 72 h、128G、8 CPU |
| E-MTAB-10801 | 588251 | 失败：确认为 64G OOM | **600004**，运行 6 h 05 min，未见 startup error 或 receipt | 72 h、196G、8 CPU |
| E-MTAB-11000 | 588252 | 运行 22 h 07 min；24 h limit 约剩 1 h 53 min | **600006**，afterany:588252；若已有 receipt 验证有效则跳过 | 72 h、128G、8 CPU |
| E-MTAB-14568 | 588253 | 运行 22 h 07 min；72 h limit 约剩 49 h 53 min | **600007**，afterany:588253；若已有 receipt 验证有效则跳过 | 72 h、196G、8 CPU |

16:44 EEST 检查显示，588250/588252/588253 active steps 的 peak RSS 约为
22.8/24.8/27.6 GiB；196G 的 10801 retry 600004 约为 13.2 GiB，pooled
smoke 600008 约为 4.5 GiB。所有 per-OCM biomass-optimum LP 已完成，但 runner
...
cohort baselines。16:44 EEST checkpoint 时，smoke job **600008** 已运行 6 h 05 min，
