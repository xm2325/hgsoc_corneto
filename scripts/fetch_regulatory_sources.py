...
DEFAULT_COLLECTRI = (
    "https://omnipathdb.org/interactions?datasets=collectri&organisms=9606&genesymbols=yes&format=tsv"
)
DEFAULT_OMNIPATH = (
    "https://omnipathdb.org/interactions?datasets=omnipath&organisms=9606&genesymbols=yes&format=tsv"
)
REQUIRED = (
    "source_genesymbol",
    "target_genesymbol",
